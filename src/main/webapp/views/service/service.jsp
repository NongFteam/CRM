            ...
            cols : [ [
                ...
                },
                {
                    ...
                    templet : function(data){
                        return str = '<a style="color:#178eb9;" href="javascript:" lay-event="serviceDetail">' +data.createDate;
                    },
                    sort : true
                },
                {
                    ...
                    title : "客户名称",
                    templet : function(data){
                        return str = '<a style="color:#178eb9;" href="javascript:" lay-event="customerDetail">' +data.customer.name;
                    },
                },
                {
                    field : "type",
                ...
                },
                {
                    ...
                    title : "创建人",
                    templet : function(data){
                        return str = '<a style="color:#178eb9;" href="javascript:" lay-event="userDetail">' +data.createrObject.account;
                    }
                },
                {
                    field : "emergency",
